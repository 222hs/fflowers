...
تاريخ اليوم: {today_str} ({cur_month_name} {now.year})
...
- الأعياد الدينية الإسلامية بحسب التقويم الهجري (عيد الفطر، عيد الأضحى، المولد النبوي، رأس السنة الهجرية، ليلة المعراج، نصف شعبان)
- موسم الحج وقدوم الحجاج بعد عيد الأضحى
- المناسبات الاجتماعية الشائعة في عُمان (موسم الأعراس، التخرجات، بداية الدراسة)
