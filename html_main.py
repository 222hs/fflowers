...
.rpt-type-btn{padding:12px;border:2px solid var(--border);border-radius:12px;background:var(--card);color:var(--text2);font-family:'Tajawal',sans-serif;font-size:15px;font-weight:700;cursor:pointer;transition:.2s;}
...
.day-title{font-size:15px;font-weight:800;color:var(--text2);}
...
.mtab{
  ...
  font-family:'Tajawal',sans-serif;font-size:14px;font-weight:600;color:var(--text3);
...
.mpill select{background:transparent;border:none;color:var(--text);
  font-family:'Tajawal',sans-serif;font-size:13px;font-weight:600;cursor:pointer;outline:none;max-width:100px;}
...
#flowerPill span:first-child{font-size:16px;}
#flowerCount{font-size:13px;font-weight:700;color:var(--gold);}
.exp-badge{font-size:10px;color:var(--text3);background:rgba(212,168,67,0.15);
...
.empty .ei{font-size:32px;margin-bottom:6px;opacity:0.3;}
...
.delbtn{background:none;border:none;cursor:pointer;color:var(--text3);font-size:14px;
...
.rent-btn{background:rgba(255,255,255,0.4);border:1px solid var(--border);border-radius:7px;
  color:var(--text3);font-size:12px;font-family:'Tajawal',sans-serif;padding:6px 10px;
...
.qty-badge{min-width:28px;padding:3px 7px;border-radius:6px;font-size:12px;font-weight:800;
...
.sell-btn{background:linear-gradient(135deg,var(--green),var(--green2));border:none;
  border-radius:7px;color:white;font-size:12px;font-weight:700;padding:6px 11px;
...
.add-prod-btn{width:100%;padding:10px;border:1px dashed var(--border);border-radius:9px;
...
.rpt-btn{padding:14px 10px;border-radius:12px;border:1px solid var(--border);
  background:var(--glass);font-family:'Tajawal',sans-serif;font-size:13px;font-weight:700;
...
.modal h3{font-size:18px;font-weight:800;color:var(--text);margin-bottom:6px;text-align:center;}
.modal p{font-size:14px;color:var(--text2);margin-bottom:16px;text-align:center;line-height:1.7;}
...
.mbtns button{flex:1;padding:13px;border:none;border-radius:10px;font-family:'Tajawal',sans-serif;
...
<div id="themePanel" style="display:none;position:fixed;top:62px;left:50%;transform:translateX(-50%);
  ...
  <div style="display:grid;grid-template-columns:repeat(5,1fr);gap:8px;">
    <div onclick="setTheme('rose')" id="th-rose" style="cursor:pointer;text-align:center;padding:8px 4px;border-radius:10px;border:2px solid transparent;transition:.2s;">
      ...
      <span style="font-size:11px;color:var(--text3);font-weight:600;">وردي</span>
    </div>
    <div onclick="setTheme('ocean')" id="th-ocean" style="cursor:pointer;text-align:center;padding:8px 4px;border-radius:10px;border:2px solid transparent;transition:.2s;">
      ...
      <span style="font-size:11px;color:var(--text3);font-weight:600;">أزرق</span>
    </div>
    <div onclick="setTheme('forest')" id="th-forest" style="cursor:pointer;text-align:center;padding:8px 4px;border-radius:10px;border:2px solid transparent;transition:.2s;">
      ...
      <span style="font-size:11px;color:var(--text3);font-weight:600;">أخضر</span>
    </div>
    <div onclick="setTheme('gold')" id="th-gold" style="cursor:pointer;text-align:center;padding:8px 4px;border-radius:10px;border:2px solid transparent;transition:.2s;">
      ...
      <span style="font-size:11px;color:var(--text3);font-weight:600;">ذهبي</span>
    </div>
    <div onclick="setTheme('lavender')" id="th-lavender" style="cursor:pointer;text-align:center;padding:8px 4px;border-radius:10px;border:2px solid transparent;transition:.2s;">
      ...
      <span style="font-size:11px;color:var(--text3);font-weight:600;">بنفسجي</span>
    </div>
  </div>
</div>
